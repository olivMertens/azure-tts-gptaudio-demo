...
def generate_random_content():
    """Generate random audio content with predefined creative scenarios"""
    content_scenarios = [
        {
            "type": "kids_story",
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Row(elem_classes="vibe-buttons"):
                ...
                generate_content_btn = gr.Button("🎪 Generate Random Content", variant="secondary", elem_classes="random-button", visible=True)
